...
Revision ID: 08b3da1cb3df
Revises: faf3ebfbe667
Create Date: 2021-12-09 12:21:40.435753
...
def downgrade():
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('sf_lead_status_mapping_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('sf_lead_source_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('sf_extract_history_id_seq'::regclass)"), autoincrement=True, nullable=False),
