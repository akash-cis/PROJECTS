# Generated by Django 3.2.5 on 2021-11-10 08:24
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership', models.CharField(blank=True, choices=[('free', 'Free'), ('active', 'Active'), ('expired', 'Expired')], default='free', max_length=100, null=True)),
                ('last_payment_on', models.DateTimeField(blank=True, null=True, verbose_name='Last payment on')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('country', models.CharField(blank=True, default='US', max_length=100, null=True, verbose_name='Country')),
                ('auto_pay', models.BooleanField(default=False, verbose_name='Pay Automatically')),
